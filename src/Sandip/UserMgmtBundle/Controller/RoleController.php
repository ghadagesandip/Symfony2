...
use Sandip\UserMgmtBundle\Entity\Role;
use Sandip\UserMgmtBundle\Form\RoleType;
...
class RoleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SandipUserMgmtBundle:Role')->findAll();
     ...
     * @Method("POST")
     * @Template("SandipUserMgmtBundle:Role:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SandipUserMgmtBundle:Role')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("SandipUserMgmtBundle:Role:edit.html.twig")
     */
